...
class am(MovingCameraScene):
    def construct(self):
        ...
        matn3 = MathTex("$ab + \dfrac{1}{2}c^{2} = \dfrac{1}{2} ( a^{2} + b^{2} )  + ab$",tex_environment = "center" ).next_to(kole_shekl , UP).shift(UP*3)
        
        self.play(TransformMatchingShapes(matn2 , matn3))
        
        matn4 = MathTex("$\dfrac{1}{2}c^{2} = \dfrac{1}{2} ( a^{2} + b^{2} )$",tex_environment = "center" ).next_to(kole_shekl , UP).shift(UP*3)
        
        self.play(TransformMatchingShapes(matn3 , matn4))
        matn5 = MathTex("$c^{2} =  a^{2} + b^{2} $",tex_environment = "center" ).next_to(kole_shekl , UP).shift(UP*3)
